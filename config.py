...
REPO_URL = getenv(
    "REPO_URL",
    b64decode("aHR0cHM6Ly9naXRodWIuY29tL2JpdGNobGFoL3B5cm9rdQ==").decode("utf-8"),
)
...
# ---- important ----
    ...
    BOTLOG_CHATID = int(os.getenv("BOTLOG_CHATID", "-100"))
...
# ---- user ----
    ...
    USER_PIC = os.getenv("USER_PIC", "./PunyaAlby/helpers/PYROBY.jpg")
...
# ---- assistant ----
    ...
    ASSISTANT_NAME = os.getenv("ASSISTANT_NAME", "ALBY")
    # set your assistant age
    ASSISTANT_AGE = os.getenv("ASSISTANT_AGE", "20")
    # set your assistant pic 
    ASSISTANT_PIC = os.getenv("ASSISTANT_PIC", "./PunyaAlby/helpers/PYROBY.jpg")
...
# ---- other ----
    ...
    UPSTREAM_REPO = os.getenv("UPSTREAM_REPO", "https://github.com/bitchlah/pyroku.git")
